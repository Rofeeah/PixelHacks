...
function updateResult(){
 if (starlightBagsScore >= 2){
         result.innerHTML = "Shop at StarlightBags(etsy)! These reusable fabric face masks are made from two layers of 100% cotton fabric with elastic ear loops. Wear this mask for protection from dust, wind, bugs, to keep you from touching your face and general face protection. Suitable for daily or occasional wear, for home, the workplace, yard work, home DIY projects and outdoors. This is not a medical device, but may serve as a protective barrier for various daily activities.";
         show_image('img/starlightbags.png', '300px', '450px', 'center');
        ...
        show_image('img/avocado.png', '300px','450px', 'Shoyu Ramen');
        avocadoScore = 0;
 }
    ...
    show_image('img/tentree.png', '300px', '450px', 'Burrito');
    tentreeScore = 0;
 }
    ...
    show_image('img/whimsyrow.png', '300px', '450px', 'Burger');
    whimsyRowScore = 0;
 } else {
    ...
    show_image('img/onyxmatter.png', '300px', '450px', 'Burger');
 }
}
